...
struct ListCoffeeShop : Identifiable{
    let id = UUID()
    let name: String
...
struct CoffeeshopProvider {
    static func allData() -> [ListCoffeeShop] {
        let coffeeshopData = [
            ListCoffeeShop(name: "Casadela Coffee", description: "Casadela is more than just a coffee shop. It's a place where you can relax, chat, work, or read in a comfortable and friendly atmosphere.", location: "Jl. Kemunging, Kota Bandung", image: "casadela", overview: """
                ...
                """),
            ListCoffeeShop(name: "Imah Kai Coffee", description: "If you love coffee, you'll love Imah Kai. Imah Kai is a local coffee shop that serves the finest quality of Arabica and Robusta beans, roasted to perfection and brewed with care.", location: "Jl. Suniaraja, Kota Bandung", image: "imahkai", overview: """
            ...
            ListCoffeeShop(name: "Kilogram Coffee", description: "Kilogram is not your average coffee shop. It's a place where you can learn about the origin, processing, and roasting of each coffee bean, and how it affects the flavor and aroma of your drink.", location: "Jl. Cipaganti, Kota Bandung", image: "kilogram", overview: """
            ...
            ListCoffeeShop(name: "Nannys Coffee", description: "Nannys coffee shop serves the most delicious and affordable coffee in the area, made with 100% organic and fair-trade beans.", location: "Jl. Bima, Kota Bandung", image: "nannys", overview: """
            ...
            ListCoffeeShop(name: "Urra Cafe", description: "Urra Cafe is more than just a coffee shop. It's a place to meet, socialize, and have fun.", location: "Jl. Teuku Umar, Kota Bandung", image: "urracafe", overview: """
